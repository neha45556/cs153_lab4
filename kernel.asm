...
80106e96:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e9b:	eb 0d                	jmp    80106eaa <shm_close+0x2a>
80106e9d:	8d 76 00             	lea    0x0(%esi),%esi
80106ea0:	83 c0 0c             	add    $0xc,%eax
for(i = 0; i < 64; i++){
80106ea3:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ea8:	74 36                	je     80106ee0 <shm_close+0x60>
	if(shm_table.shm_pages[i].id == id){
80106eaa:	3b 18                	cmp    (%eax),%ebx
80106eac:	75 f2                	jne    80106ea0 <shm_close+0x20>
		shm_table.shm_pages[i].refcnt--;
80106eae:	8b 48 08             	mov    0x8(%eax),%ecx
80106eb1:	8d 51 ff             	lea    -0x1(%ecx),%edx
		if(shm_table.shm_pages[i].refcnt == 0){
80106eb4:	85 d2                	test   %edx,%edx
		shm_table.shm_pages[i].refcnt--;
80106eb6:	89 50 08             	mov    %edx,0x8(%eax)
		if(shm_table.shm_pages[i].refcnt == 0){
80106eb9:	75 e5                	jne    80106ea0 <shm_close+0x20>
			shm_table.shm_pages[i].id = 0;
80106ebb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106ec1:	83 c0 0c             	add    $0xc,%eax
			shm_table.shm_pages[i].frame = 0;
80106ec4:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
			shm_table.shm_pages[i].refcnt = 0;
80106ecb:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
for(i = 0; i < 64; i++){
80106ed2:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ed7:	75 d1                	jne    80106eaa <shm_close+0x2a>
80106ed9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		}
	}
}
release(&(shm_table.lock));
80106ee0:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ee7:	e8 54 d3 ff ff       	call   80104240 <release>
...
80106eec:	83 c4 14             	add    $0x14,%esp
